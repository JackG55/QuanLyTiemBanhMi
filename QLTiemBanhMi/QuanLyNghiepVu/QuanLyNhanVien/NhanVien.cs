...
namespace QLTiemBanhMi.QuanLyNghiepVu.QuanLyNhanVien
{
    public partial class NhanVien : Form
    {
        ...
        private void chiTietLoaiNV_UpdateEventHandler1(object sender, ChiTietLoaiNV.UpdateEventArgs args)
        {
        ...
        {
            Program.opt = 2;
            ChiTietLoaiNV chiTietLoaiNV = new ChiTietLoaiNV(this);
            chiTietLoaiNV.UpdateEventHandler += chiTietLoaiNV_UpdateEventHandler1;
            chiTietLoaiNV.ShowDialog();
        }
